...
if (VCPKG_LIBRARY_LINKAGE STREQUAL static)
    ...
    foreach(_pkg_comp ${_pkg_components})
        ...
        string(REPLACE "Cflags: \"-I\${includedir}\"" "Cflags: \"-I\${includedir}\" -DSLEEF_STATIC_LIBS=1" _content ${_content})
        file(WRITE ${_pkg_comp} ${_content})
    endforeach()
    file(GLOB _pkg_components "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/*.pc")
    foreach(_pkg_comp ${_pkg_components})
        file(READ ${_pkg_comp} _content)
        string(REPLACE "Cflags: \"-I\${includedir}\"" "Cflags: \"-I\${includedir}\" -DSLEEF_STATIC_LIBS=1" content ${_content})
        file(WRITE ${_pkg_comp} ${_content})
    endforeach()
endif()
